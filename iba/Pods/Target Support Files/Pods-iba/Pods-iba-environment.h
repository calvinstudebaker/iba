...
// LFHeatMap
#define COCOAPODS_POD_AVAILABLE_LFHeatMap
#define COCOAPODS_VERSION_MAJOR_LFHeatMap 1
#define COCOAPODS_VERSION_MINOR_LFHeatMap 0
#define COCOAPODS_VERSION_PATCH_LFHeatMap 1
